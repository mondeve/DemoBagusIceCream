...
export default function FormNooInput() {
  ...
  return (
    <ComponentCard title="Form NOO">
      <div className="space-y-6">
        <div>
          <Label htmlFor="input">Nama Lengkap Sales</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">ID Sales</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">Area Sales</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">Nama Toko</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">Nama Pemilik Toko</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">Kontak Toko</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">Alamat Toko</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">Kecamatan</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">Desa</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">Titik Koordinat Maps</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">Daya Listrik</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">Tanggal Kirim Freezer</Label>
          <Input type="text" id="input" />
        </div>
        <div>
          <Label htmlFor="input">NIK KTP</Label>
          <Input type="text" id="input" />
        </div>
        <div>
